...
public class PostListDetailResponse {
    ...
    public PostListDetailResponse(Long postId, Long userId, String userProfileImageUrl, String username, String nickName, String postImageUrl1, String postImageUrl2, String postImageUrl3, String postImageUrl4, String postImageUrl5, String postImageUrl6, String postImageUrl7, String postImageUrl8, String postImageUrl9, String postImageUrl10, Boolean isPostLike, String content, Long commentSize, LocalDateTime updatedAt) {
        this.postId = postId;
        this.userId = userId;
