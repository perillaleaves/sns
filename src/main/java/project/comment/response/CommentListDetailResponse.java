...
public class CommentListDetailResponse {
    ...
    public CommentListDetailResponse(Long commentId, String userProfileImage, String userName, String nickName, String commentContent, Long reCommentSize, Boolean isCommentOwner, LocalDateTime updatedAt) {
